...
<head>
    <meta charset="UTF-8">
    <title>จัดการแผนก - E-Document</title>
...
<body>
        ...
        <div class="flex-grow-1 p-4" style="overflow-y: auto;">
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3 class="fw-bold text-success"><i class="bi bi-building me-2"></i>จัดการแผนก/หน่วยงาน</h3>
                        ...
                        <table class="table table-hover align-middle mb-0">
                            <thead class="bg-light">
                                <tr>
                                    ...
                                    <th>ชื่อแผนก</th>
                                    <th>วันที่สร้าง</th>
                                    <th class="text-end pe-4" width="25%">จัดการ</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold text-secondary"><?php echo htmlspecialchars($row['name']); ?></td>
                                    <td class="text-muted small"><?php echo $row['created_at']; ?></td>
                                    <td class="text-end pe-4">
                                        <a href="manage_permissions.php?id=<?php echo $row['id']; ?>" 
                                           class="btn btn-sm btn-outline-info rounded-pill me-1" 
                                           title="จัดการสิทธิ์การเข้าถึง">
                                            <i class="bi bi-shield-lock"></i> สิทธิ์
                                        </a>
    ...
    <script>
        function confirmDelete(id) {
            Swal.fire({
                title: 'ยืนยันการลบ?',
                text: "หากลบ แผนกนี้จะหายไปจากระบบทันที",
                icon: 'warning',
