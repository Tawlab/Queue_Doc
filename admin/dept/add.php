...
<head>
    <meta charset="UTF-8">
    <title>เพิ่มแผนก - E-Document</title>
        ...
        <div class="flex-grow-1 p-4" style="overflow-y: auto;">
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3 class="fw-bold text-success"><i class="bi bi-building-add me-2"></i>เพิ่มแผนกใหม่</h3>
                        ...
                        <?php if($success): ?>
                            <script>
                                Swal.fire({
                                    ...
                                    window.location.href = 'index.php'; // กลับหน้า Index เมื่อเสร็จ
                                });
                            </script>
                        <?php endif; ?>
                            ...
                            <div class="row">
                                <div class="col-md-8 mx-auto">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="name" class="form-control form-control-lg rounded-3" placeholder="ระบุชื่อแผนก" required autofocus>
                                    </div>
                                    
                                    <div class="d-grid gap-2">
                                        <button type="submit" name="save_dept" class="btn btn-success btn-lg rounded-pill shadow-sm">
